            ...
            {open ? (
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
                ...
                <g id="SVGRepo_iconCarrier"> 
                  <path d="M4 18L20 18" stroke="var(--text-color)" strokeWidth="2" stroke-linecap="round"></path> 
                  <path d="M4 12L20 12" stroke="var(--text-color)" strokeWidth="2" stroke-linecap="round"></path> 
                  <path d="M4 6L20 6" stroke="var(--text-color)" strokeWidth="2" stroke-linecap="round"></path> 
                </g>
              </svg>
            )}
          </button>
